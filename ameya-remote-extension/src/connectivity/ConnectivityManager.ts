...
export class ConnectivityManager {
    ...
    static initialize() {
        this.outputChannel = vscode.window.createOutputChannel("Ameya Remote Session");
    }
    ...
    static async showConnectionInfo(port: number) {
        ...
        // Protocol: ameya://connect?ip=...&port=...&bt=...
        const connectionString = `ameya://connect?ip=${localIp}&port=${port}${bluetoothMac ? `&bt=${bluetoothMac}` : ''}`;
        ...
        try {
            ...
            this.outputChannel.appendLine("           AMEYA REMOTE SESSION: READY              ");
            this.outputChannel.appendLine("====================================================");
            this.outputChannel.appendLine("");
            this.outputChannel.appendLine("Scan this QR code in the Ameya Android app to connect:");
            this.outputChannel.appendLine("");
            ...
            console.error('[Ameya Remote] QR generation failed:', err);
