package com.ameya.intelligence.impl.ide.antigravity.client
...
import com.ameya.intelligence.impl.ide.antigravity.services.AntigravityRemoteDebugLog
...
class RemoteSessionClient @Inject constructor(
    ...
    companion object {
        private const val PREFS_NAME = "ameya_remote_session"
    ...
    fun setConversationMode(mode: com.ameya.intelligence.domain.models.ConversationMode) {
