...
import com.ameya.intelligence.data.remote.api.AiToolPropertyItems
...
import com.ameya.intelligence.data.remote.api.MAX_REMOTE_BODY_BYTES
import com.ameya.intelligence.data.remote.api.awaitResponse
import com.ameya.intelligence.data.remote.api.readUtf8Limited
...
class McpClientManager @Inject constructor(
    ...
    suspend fun callTool(toolName: String, arguments: Map<String, Any?>): ToolResult {
        ...
        val response = try {
            ...
            return ToolResult.Error("MCP tool call timed out after 60s", com.ameya.intelligence.tools.ErrorType.TIMEOUT, recoverable = true)
