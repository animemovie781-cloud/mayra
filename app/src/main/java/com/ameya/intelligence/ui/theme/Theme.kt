...
package com.ameya.intelligence.ui.theme
...
// ─── Ameya Gradients & Design Tokens ──────────────────────────────────────────

@Immutable
class AmeyaGradients(
...
val LocalAmeyaGradients = staticCompositionLocalOf<AmeyaGradients> {
    error("No AmeyaGradients provided")
}

@Composable
fun ameyaGradients(darkTheme: Boolean): AmeyaGradients {
...
fun AmeyaTheme(
    ...
    val gradients = ameyaGradients(darkTheme)
    ...
    CompositionLocalProvider(
        LocalAmeyaGradients provides gradients
    ) {
        MaterialTheme(
